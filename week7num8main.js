...
/*console.log('Are both costs same? (Equality Operator)');

console.log('Are both costs same? (Strict Equality Operator)');

console.log('The advertised cost is not the same as the actual cost: ');*/
